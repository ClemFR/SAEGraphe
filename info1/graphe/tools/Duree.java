...
/**
 * Gestion de durées.
 * Une durée est stockée sous la forme d'un entier positif représentant un nombre d'heures.
 ...
 * la durée est convertie en heures et est arrondie pour donner un nombre entier.
...
public class Duree {
     ...
     * Exemple : si la duree est de 2 heures, le tableau renvoyé sera [0, 0, 0, 2].
     * Exemple 2 : si la duree est de 342 heures, le tableau renvoyé sera [9, 3, 2, 3].
